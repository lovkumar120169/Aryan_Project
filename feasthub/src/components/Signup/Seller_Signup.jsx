...
const Seller_Signup = () => {
  ...
  const seller_signUp = (e) => {
    ...
    axios
      ...
      .then((res) => {
        console.log("here we the response", res.data);
    ...
    //       photoURL: userDetails.bussiness,
    //     });

    //     console.log("user cred line 12", res);
    //     console.log("test");
    //   })
    //   .catch((error) => {
    //     console.log(error);
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  // value={password}
                  onChange={(e) =>
                    SetuserDetails({ ...userDetails, gst: e.target.value })
                  }
                  name="gstNo"
                  class="mt-1 p-2 w-full border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300"
                />
